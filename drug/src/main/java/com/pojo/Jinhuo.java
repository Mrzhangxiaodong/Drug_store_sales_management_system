...
public class Jinhuo {
	...
	private String begindate;//生产日期
	private String date;//日期

	@Pattern(regexp = "^.{1,30}$",message = "格式错误或超过字数限制")
	@NotBlank(message="ph不能为空")
	private String pihao;//生产批号
	private String beizhu;//备注
	private String location;//位置
	private String unit;//
	private String guige;//规格
	private String tiaoxingma;//药品条形码
	private String jinhuo_time;//进货时间
	private String gonghuoshang;//供货商
