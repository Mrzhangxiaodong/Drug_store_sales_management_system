...
import com.pojo.Rxdrug;
import com.pojo.Rxperson;
import com.pojo.Sell;
import com.pojo.Sellover;
import com.pojo.Sellrecords;
...
public class SellService {
	...
	public void PrintService() {
		...
		if(!check.isEmpty()){
			...
			p.printSheet("0001","北京同仁堂药店","张小东",sum,"支付宝","普通会员","7802273","宣武区大栅栏商业街路南20号",check);
		}
	}
	//倒序输出结果
