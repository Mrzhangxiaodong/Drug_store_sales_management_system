...
public class JinhuoService {
		...
		DrugMapper drug;
		/**
		 * ��ӹ����̣�������ݿ���ͬ���ļ�¼������Msg.fail�����û�о���ӣ����ҷ���Msg.success
		 * @param it(��������ֵ)
		 * @return
		 */
		...
		public List<Drug> ForSelectService(String qd) {
			if(qd==""||qd==null){
				List re = drug.GetAllDrug();
				return re;
			}else{
				if(Boolean_tiaoxingma.CheckParam(qd)){
					List re2 = drug.QueryByTiao(qd);
					return re2;
				}else{
					List re3 = drug.QueryByName(qd);
					return re3;
				}
			}
		}
		public PageInfo<Jinhuo> QueryJFYService(Integer pn, String qd) {
			if(qd==""||qd==null){
				...
				//ʹ��pageinfo��װ��ѯ��Ľ����ֻ��Ҫ��pageinfo����ҳ�������PageInfo(ee,5)  5��������ʾ����ҳ	
